			...
			<Layout style={{ maxHeight: "1000px" }}>
				<Header
					...
					<Menu theme="light" mode="horizontal" style={{ backgroundColor: "#f7f7f7" }} defaultSelectedKeys={["postings"]} onClick={this.onTabChange}>
						<Menu.Item key="postings" style={{ float: "left" }} icon={<HomeOutlined />}>
							Postings
						</Menu.Item>
						<Menu.Item style={{ float: "left" }} key="applications" icon={<UserOutlined />}>
							Applications
						</Menu.Item>
						<Menu.Item key="profile" style={{ float: "left" }} icon={<GlobalOutlined />}>
							Profile
						</Menu.Item>
					</Menu>
				</Header>
